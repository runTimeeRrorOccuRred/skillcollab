...
final privategroupDescriptionViewModel = ChangeNotifierProvider((ref) => PrivateGroupDescriptionViewModel(ref: ref));

class PrivateGroupDescriptionViewModel extends BaseViewModel<BaseScreenView> {
  Ref ref;
  PrivateGroupDescriptionViewModel({required this.ref}) : super();
