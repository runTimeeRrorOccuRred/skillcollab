...
import 'package:skill_colab/view/screens/groups/groupDescription/private_group_description_view_model.dart';
...
class PrivateGroupDescriptionView extends ConsumerStatefulWidget {
  const PrivateGroupDescriptionView({super.key,});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _PrivateGroupDescriptionViewState();
}

class _PrivateGroupDescriptionViewState extends ConsumerState<PrivateGroupDescriptionView> with BaseScreenView{  

  late PrivateGroupDescriptionViewModel _viewModel;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      _viewModel = ref.read(privategroupDescriptionViewModel);
      _viewModel.getLatLong(ref.read(privateGroupProfileViewModel).groupData?.location ?? "");
      _viewModel.attachView(this);
      Logger.printInfo((ref.read(privateGroupProfileViewModel).groupData?.rules ?? "").replaceAll("&lt;", "<"));
      Future.delayed(const Duration(seconds: 1), () async {
        await controller.setText((ref.read(privateGroupProfileViewModel).groupData?.rules ?? "").replaceAll("&lt;", "<"));
      });
      final String s = ref.read(privateGroupProfileViewModel).groupData?.rules ?? '';
  ...
  Widget build(BuildContext context) {
    ...
    _viewModel = ref.watch(privategroupDescriptionViewModel);
    return Scaffold(
      appBar: AppBar(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    gapH8,
                    ReadMoreText(
                      ref.read(privateGroupProfileViewModel).groupData?.description ?? "",
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        gapW6,
                        Text((ref.read(privateGroupProfileViewModel).groupData?.follower ?? 0).toString(), style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: kBlack),),
                      ],
                    ),
                    gapH4,
                    ...
                    gapH4,
                    Text(
                      "Group created on ${DateFormat.yMMMMd('en_US').format(ref.read(privateGroupProfileViewModel).groupData?.createdAt ?? DateTime.now())}", 
                      style: const TextStyle(fontSize: 12, color: Color(0xff5D5D5D)),
                    ),
                  ],
                ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    gapH8,
                    Text(
                      ref.read(privateGroupProfileViewModel).groupData?.location ?? "", 
                      style: const TextStyle(fontSize: 12, color: Color(0xff5D5D5D)),
                    ),
                    gapH8,
                    Container(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        gapW6,
                        Text("${ref.read(privateGroupProfileViewModel).getGroupResponseModel.data?.postToday.toString() ?? "0"} New Posts Today", style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: kBlack),),
                      ],
                    ),
                    gapH4,
                    Divider(color: Colors.grey[500],),
                    ...
                    Row(
                      children: [
                        ...
                        gapW6,
                        Text("${ref.read(privateGroupProfileViewModel).getGroupResponseModel.data?.postLastMonth.toString() ?? "0"} New Posts Last Month", style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: kBlack),),
                      ],
                    ),
                    gapH4,
                    Divider(color: Colors.grey[500],),
                    ...
                    Row(
                      children: [
                        ...
                        gapW6,
                        Text("${ref.read(privateGroupProfileViewModel).getGroupResponseModel.data?.followersLastWeek.toString() ?? "0"} Followers Last Week", style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: kBlack),),
                      ],
                    ),
                    gapH4,
                  ],
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            if((ref.read(privateGroupProfileViewModel).groupData?.rating ?? 0) > 0) {
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context) => PrivateGroupRatingView(
                                groupId: ref.watch(privateGroupProfileViewModel).groupData?.id ?? "", 
                          ...
                          child: Row(
                            children: [
                              Text((ref.read(privateGroupProfileViewModel).groupData?.rating ?? "").toString(), style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: Color(0xff5D5D5D)),),
                              gapW4,
                              RatingBarIndicator(
                                rating: ref.read(privateGroupProfileViewModel).groupData?.averageRating ?? 0,
                    ...
                    if (AppConstants.userId == ref.read(privateGroupProfileViewModel).groupData?.userId) MaterialButton(
                      onPressed: () => context.pushNamed(
                                            AppRoute.addGroupRating.name, 
                                            extra: ref.read(privateGroupProfileViewModel).groupData?.id ?? "",
                                          ),
              ...
              gapH12,
              Visibility(
                visible: ref.watch(privateGroupProfileViewModel).groupData?.rules != null,
                child: Container(
                  width: size.width,
                  padding: const EdgeInsets.all(16),
                  margin: const EdgeInsets.symmetric(horizontal: 16),
