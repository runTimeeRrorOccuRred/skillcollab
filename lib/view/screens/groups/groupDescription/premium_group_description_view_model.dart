...
final premiumGroupDescriptionViewModel = ChangeNotifierProvider((ref) => PremiumGroupDescriptionViewModel(ref: ref));

class PremiumGroupDescriptionViewModel extends BaseViewModel<BaseScreenView> {
  Ref ref;
  PremiumGroupDescriptionViewModel({required this.ref}) : super();
