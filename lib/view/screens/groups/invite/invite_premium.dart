...
class InvitePremiumView extends ConsumerStatefulWidget {
  const InvitePremiumView({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _InvitePremiumViewState();
}

class _InvitePremiumViewState extends ConsumerState<InvitePremiumView> {
                    ...
                    children: [
                      ListTile(
                        ...
                        trailing: InviteButton(
                          groupId: ref.read(premiumGroupProfileViewModel).groupData?.id ?? "", invitedUserId: _viewModel.getFollowersByUserResponseModel.data?[index].id ?? "",),
                      ),
                      Visibility(
      ...
      child: Container(
        ...
        child: MaterialButton(
          onPressed: () {
            ...
            ref.read(premiumGroupProfileViewModel).triggerInviteNotification(InviteRequestModel(
