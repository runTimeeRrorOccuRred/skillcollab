...
class InvitePrivateView extends ConsumerStatefulWidget {
  const InvitePrivateView({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _InvitePrivateViewState();
}

class _InvitePrivateViewState extends ConsumerState<InvitePrivateView> {
                    ...
                    children: [
                      ListTile(
                        ...
                        trailing: InviteButton(
                          groupId: ref.read(privateGroupProfileViewModel).groupData?.id ?? "", invitedUserId: _viewModel.getFollowersByUserResponseModel.data?[index].id ?? "",),
                      ),
                      Visibility(
      ...
      child: Container(
        ...
        child: MaterialButton(
          onPressed: () {
            ...
            ref.read(privateGroupProfileViewModel).triggerInviteNotification(InviteRequestModel(
