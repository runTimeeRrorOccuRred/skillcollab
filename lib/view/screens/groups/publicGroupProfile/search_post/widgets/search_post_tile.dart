...
class SearchGroupPostTile extends ConsumerStatefulWidget {
  final Post postData;
  final int index;
  const SearchGroupPostTile({super.key, required this.postData, required this.index});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _SearchGroupPostTileState();
}

class _SearchGroupPostTileState extends ConsumerState<SearchGroupPostTile> {
