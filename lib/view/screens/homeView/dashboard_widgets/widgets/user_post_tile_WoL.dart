// ignore_for_file: file_names, avoid_dynamic_calls, deprecated_member_use
...
class UserPostTileWithoutLogin extends ConsumerStatefulWidget {
  final PeopleAndGroupPostWOL userPostData;
  const UserPostTileWithoutLogin({super.key, required this.userPostData});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _UserPostTileState();
}

class _UserPostTileState extends ConsumerState<UserPostTileWithoutLogin> {
