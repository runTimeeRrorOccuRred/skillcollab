...
class ColorPickerBottomSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _ColorPickerBottomSheetState();
}

class _ColorPickerBottomSheetState extends ConsumerState<ColorPickerBottomSheet> with BaseScreenView{
                          ...
                          GridView.count(
                            ...
                            children: List.generate(colors.length, (index) {
                              return GestureDetector(
                                onTap: (){
                                  ref.read(createPostViewModel).setColorCode(colors[index]);
                                  context.pop();
                                },
                                child: Container(
