// ignore_for_file: prefer_if_elements_to_conditional_expressions, deprecated_member_use, duplicate_ignore, avoid_print
...
class SinglePostView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _SinglePostViewState();
}

class _SinglePostViewState extends ConsumerState<SinglePostView>  with BaseScreenView {
  ...
  void initState() {
    super.initState();
    Logger.printInfo(widget.postId);
    // Logger.printError(widget.postDetails.groupId?.id ?? '',);
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      _viewModel = ref.read(singlePostViewModel);
      _viewModel.attachView(this);
      _viewModel.getSinglePostData(context, widget.postId);
    });    
