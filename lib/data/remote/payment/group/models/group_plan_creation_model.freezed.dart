...
GroupPlanCreationRequestModel _$GroupPlanCreationRequestModelFromJson(
    Map<String, dynamic> json) {
  return _GroupPlanCreationRequestModel.fromJson(json);
}

/// @nodoc
mixin _$GroupPlanCreationRequestModel {
  ...
  @JsonKey(ignore: true)
  $GroupPlanCreationRequestModelCopyWith<GroupPlanCreationRequestModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GroupPlanCreationRequestModelCopyWith<$Res> {
  factory $GroupPlanCreationRequestModelCopyWith(
          GroupPlanCreationRequestModel value,
          $Res Function(GroupPlanCreationRequestModel) then) =
      _$GroupPlanCreationRequestModelCopyWithImpl<$Res,
          GroupPlanCreationRequestModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$GroupPlanCreationRequestModelCopyWithImpl<$Res,
        $Val extends GroupPlanCreationRequestModel>
    implements $GroupPlanCreationRequestModelCopyWith<$Res> {
  _$GroupPlanCreationRequestModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GroupPlanCreationRequestModelImplCopyWith<$Res>
    implements $GroupPlanCreationRequestModelCopyWith<$Res> {
  factory _$$GroupPlanCreationRequestModelImplCopyWith(
          _$GroupPlanCreationRequestModelImpl value,
          $Res Function(_$GroupPlanCreationRequestModelImpl) then) =
      __$$GroupPlanCreationRequestModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "groupId") String? groupId,
...
/// @nodoc
class __$$GroupPlanCreationRequestModelImplCopyWithImpl<$Res>
    extends _$GroupPlanCreationRequestModelCopyWithImpl<$Res,
        _$GroupPlanCreationRequestModelImpl>
    implements _$$GroupPlanCreationRequestModelImplCopyWith<$Res> {
  __$$GroupPlanCreationRequestModelImplCopyWithImpl(
      _$GroupPlanCreationRequestModelImpl _value,
      $Res Function(_$GroupPlanCreationRequestModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GroupPlanCreationRequestModelImpl(
      groupId: freezed == groupId
          ? _value.groupId
          : groupId // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$GroupPlanCreationRequestModelImpl
    implements _GroupPlanCreationRequestModel {
  const _$GroupPlanCreationRequestModelImpl(
  ...
  factory _$GroupPlanCreationRequestModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GroupPlanCreationRequestModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GroupPlanCreationRequestModel(groupId: $groupId, productName: $productName, monthlyPlanAmount: $monthlyPlanAmount, quartPlanAmount: $quartPlanAmount, yearlyPlanAmount: $yearlyPlanAmount)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GroupPlanCreationRequestModelImpl &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, groupId, productName,
      monthlyPlanAmount, quartPlanAmount, yearlyPlanAmount);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$GroupPlanCreationRequestModelImplCopyWith<
          _$GroupPlanCreationRequestModelImpl>
      get copyWith => __$$GroupPlanCreationRequestModelImplCopyWithImpl<
          _$GroupPlanCreationRequestModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GroupPlanCreationRequestModelImplToJson(
      this,
    );
  }
}

abstract class _GroupPlanCreationRequestModel
    implements GroupPlanCreationRequestModel {
  const factory _GroupPlanCreationRequestModel(
  ...
  factory _GroupPlanCreationRequestModel.fromJson(Map<String, dynamic> json) =
      _$GroupPlanCreationRequestModelImpl.fromJson;
...
GroupPlanCreationResponseModel _$GroupPlanCreationResponseModelFromJson(
    Map<String, dynamic> json) {
  return _GroupPlanCreationResponseModel.fromJson(json);
}

/// @nodoc
mixin _$GroupPlanCreationResponseModel {
  @JsonKey(name: "code")
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $GroupPlanCreationResponseModelCopyWith<GroupPlanCreationResponseModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GroupPlanCreationResponseModelCopyWith<$Res> {
  factory $GroupPlanCreationResponseModelCopyWith(
          GroupPlanCreationResponseModel value,
          $Res Function(GroupPlanCreationResponseModel) then) =
      _$GroupPlanCreationResponseModelCopyWithImpl<$Res,
          GroupPlanCreationResponseModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$GroupPlanCreationResponseModelCopyWithImpl<$Res,
        $Val extends GroupPlanCreationResponseModel>
    implements $GroupPlanCreationResponseModelCopyWith<$Res> {
  _$GroupPlanCreationResponseModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GroupPlanCreationResponseModelImplCopyWith<$Res>
    implements $GroupPlanCreationResponseModelCopyWith<$Res> {
  factory _$$GroupPlanCreationResponseModelImplCopyWith(
          _$GroupPlanCreationResponseModelImpl value,
          $Res Function(_$GroupPlanCreationResponseModelImpl) then) =
      __$$GroupPlanCreationResponseModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "code") int? code,
...
/// @nodoc
class __$$GroupPlanCreationResponseModelImplCopyWithImpl<$Res>
    extends _$GroupPlanCreationResponseModelCopyWithImpl<$Res,
        _$GroupPlanCreationResponseModelImpl>
    implements _$$GroupPlanCreationResponseModelImplCopyWith<$Res> {
  __$$GroupPlanCreationResponseModelImplCopyWithImpl(
      _$GroupPlanCreationResponseModelImpl _value,
      $Res Function(_$GroupPlanCreationResponseModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GroupPlanCreationResponseModelImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$GroupPlanCreationResponseModelImpl
    implements _GroupPlanCreationResponseModel {
  const _$GroupPlanCreationResponseModelImpl(
      {@JsonKey(name: "code") this.code,
      @JsonKey(name: "message") this.message,
      @JsonKey(name: "isSuccess") this.isSuccess,
      @JsonKey(name: "data") this.data});

  factory _$GroupPlanCreationResponseModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GroupPlanCreationResponseModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GroupPlanCreationResponseModel(code: $code, message: $message, isSuccess: $isSuccess, data: $data)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GroupPlanCreationResponseModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GroupPlanCreationResponseModelImplCopyWith<
          _$GroupPlanCreationResponseModelImpl>
      get copyWith => __$$GroupPlanCreationResponseModelImplCopyWithImpl<
          _$GroupPlanCreationResponseModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GroupPlanCreationResponseModelImplToJson(
      this,
    );
  }
}

abstract class _GroupPlanCreationResponseModel
    implements GroupPlanCreationResponseModel {
  const factory _GroupPlanCreationResponseModel(
  ...
  factory _GroupPlanCreationResponseModel.fromJson(Map<String, dynamic> json) =
      _$GroupPlanCreationResponseModelImpl.fromJson;
