...
_$GetQuestionCommentResponseModelImpl
    _$$GetQuestionCommentResponseModelImplFromJson(Map<String, dynamic> json) =>
        _$GetQuestionCommentResponseModelImpl(
          code: json['code'] as int?,
          message: json['message'] as String?,
          isSuccess: json['isSuccess'] as bool?,
          data: (json['data'] as List<dynamic>?)
              ?.map((e) => QuestionComment.fromJson(e as Map<String, dynamic>))
              .toList(),
        );

Map<String, dynamic> _$$GetQuestionCommentResponseModelImplToJson(
        _$GetQuestionCommentResponseModelImpl instance) =>
    <String, dynamic>{
      'code': instance.code,
...
_$QuestionCommentImpl _$$QuestionCommentImplFromJson(
        Map<String, dynamic> json) =>
    _$QuestionCommentImpl(
      postId: json['postId'],
...
Map<String, dynamic> _$$QuestionCommentImplToJson(
        _$QuestionCommentImpl instance) =>
    <String, dynamic>{
