...
_$UserSubscriptionPlanRequestModelImpl
    _$$UserSubscriptionPlanRequestModelImplFromJson(
...
Map<String, dynamic> _$$UserSubscriptionPlanRequestModelImplToJson(
        _$UserSubscriptionPlanRequestModelImpl instance) =>
    <String, dynamic>{
...
_$UserSubscriptionPlanResponseModelImpl
    _$$UserSubscriptionPlanResponseModelImplFromJson(
            Map<String, dynamic> json) =>
        _$UserSubscriptionPlanResponseModelImpl(
...
Map<String, dynamic> _$$UserSubscriptionPlanResponseModelImplToJson(
        _$UserSubscriptionPlanResponseModelImpl instance) =>
    <String, dynamic>{
      'code': instance.code,
