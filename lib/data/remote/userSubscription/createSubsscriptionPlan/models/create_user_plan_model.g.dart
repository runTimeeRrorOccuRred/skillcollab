...
_$CreateUserPlanRequestModelImpl _$$CreateUserPlanRequestModelImplFromJson(
...
Map<String, dynamic> _$$CreateUserPlanRequestModelImplToJson(
        _$CreateUserPlanRequestModelImpl instance) =>
    <String, dynamic>{
...
_$CreateUserPlanResponseModelImpl _$$CreateUserPlanResponseModelImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$CreateUserPlanResponseModelImplToJson(
        _$CreateUserPlanResponseModelImpl instance) =>
    <String, dynamic>{
      'code': instance.code,
