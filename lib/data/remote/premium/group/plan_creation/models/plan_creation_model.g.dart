...
_$PlanCreationRequestModelImpl _$$PlanCreationRequestModelImplFromJson(
...
Map<String, dynamic> _$$PlanCreationRequestModelImplToJson(
        _$PlanCreationRequestModelImpl instance) =>
    <String, dynamic>{
...
_$PlanCreationResponseModelImpl _$$PlanCreationResponseModelImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$PlanCreationResponseModelImplToJson(
        _$PlanCreationResponseModelImpl instance) =>
    <String, dynamic>{
      'code': instance.code,
