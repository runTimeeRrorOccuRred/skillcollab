...
part of 'plan_creation_model.dart';
...
PlanCreationRequestModel _$PlanCreationRequestModelFromJson(
    Map<String, dynamic> json) {
  return _PlanCreationRequestModel.fromJson(json);
}

/// @nodoc
mixin _$PlanCreationRequestModel {
  ...
  @JsonKey(ignore: true)
  $PlanCreationRequestModelCopyWith<PlanCreationRequestModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PlanCreationRequestModelCopyWith<$Res> {
  factory $PlanCreationRequestModelCopyWith(PlanCreationRequestModel value,
          $Res Function(PlanCreationRequestModel) then) =
      _$PlanCreationRequestModelCopyWithImpl<$Res, PlanCreationRequestModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$PlanCreationRequestModelCopyWithImpl<$Res,
        $Val extends PlanCreationRequestModel>
    implements $PlanCreationRequestModelCopyWith<$Res> {
  _$PlanCreationRequestModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PlanCreationRequestModelImplCopyWith<$Res>
    implements $PlanCreationRequestModelCopyWith<$Res> {
  factory _$$PlanCreationRequestModelImplCopyWith(
          _$PlanCreationRequestModelImpl value,
          $Res Function(_$PlanCreationRequestModelImpl) then) =
      __$$PlanCreationRequestModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "groupId") String? groupId,
...
/// @nodoc
class __$$PlanCreationRequestModelImplCopyWithImpl<$Res>
    extends _$PlanCreationRequestModelCopyWithImpl<$Res,
        _$PlanCreationRequestModelImpl>
    implements _$$PlanCreationRequestModelImplCopyWith<$Res> {
  __$$PlanCreationRequestModelImplCopyWithImpl(
      _$PlanCreationRequestModelImpl _value,
      $Res Function(_$PlanCreationRequestModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PlanCreationRequestModelImpl(
      groupId: freezed == groupId
          ? _value.groupId
          : groupId // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$PlanCreationRequestModelImpl implements _PlanCreationRequestModel {
  const _$PlanCreationRequestModelImpl(
  ...
  factory _$PlanCreationRequestModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$PlanCreationRequestModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'PlanCreationRequestModel(groupId: $groupId, productName: $productName, monthlyPlanAmount: $monthlyPlanAmount, quartPlanAmount: $quartPlanAmount, yearlyPlanAmount: $yearlyPlanAmount)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PlanCreationRequestModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PlanCreationRequestModelImplCopyWith<_$PlanCreationRequestModelImpl>
      get copyWith => __$$PlanCreationRequestModelImplCopyWithImpl<
          _$PlanCreationRequestModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PlanCreationRequestModelImplToJson(
      this,
    );
  }
}

abstract class _PlanCreationRequestModel implements PlanCreationRequestModel {
  const factory _PlanCreationRequestModel(
  ...
  factory _PlanCreationRequestModel.fromJson(Map<String, dynamic> json) =
      _$PlanCreationRequestModelImpl.fromJson;
...
PlanCreationResponseModel _$PlanCreationResponseModelFromJson(
    Map<String, dynamic> json) {
  return _PlanCreationResponseModel.fromJson(json);
}

/// @nodoc
mixin _$PlanCreationResponseModel {
  @JsonKey(name: "code")
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $PlanCreationResponseModelCopyWith<PlanCreationResponseModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PlanCreationResponseModelCopyWith<$Res> {
  factory $PlanCreationResponseModelCopyWith(PlanCreationResponseModel value,
          $Res Function(PlanCreationResponseModel) then) =
      _$PlanCreationResponseModelCopyWithImpl<$Res, PlanCreationResponseModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$PlanCreationResponseModelCopyWithImpl<$Res,
        $Val extends PlanCreationResponseModel>
    implements $PlanCreationResponseModelCopyWith<$Res> {
  _$PlanCreationResponseModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PlanCreationResponseModelImplCopyWith<$Res>
    implements $PlanCreationResponseModelCopyWith<$Res> {
  factory _$$PlanCreationResponseModelImplCopyWith(
          _$PlanCreationResponseModelImpl value,
          $Res Function(_$PlanCreationResponseModelImpl) then) =
      __$$PlanCreationResponseModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "code") int? code,
...
/// @nodoc
class __$$PlanCreationResponseModelImplCopyWithImpl<$Res>
    extends _$PlanCreationResponseModelCopyWithImpl<$Res,
        _$PlanCreationResponseModelImpl>
    implements _$$PlanCreationResponseModelImplCopyWith<$Res> {
  __$$PlanCreationResponseModelImplCopyWithImpl(
      _$PlanCreationResponseModelImpl _value,
      $Res Function(_$PlanCreationResponseModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PlanCreationResponseModelImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$PlanCreationResponseModelImpl implements _PlanCreationResponseModel {
  const _$PlanCreationResponseModelImpl(
      {@JsonKey(name: "code") this.code,
      @JsonKey(name: "message") this.message,
      @JsonKey(name: "isSuccess") this.isSuccess,
      @JsonKey(name: "data") this.data});

  factory _$PlanCreationResponseModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$PlanCreationResponseModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'PlanCreationResponseModel(code: $code, message: $message, isSuccess: $isSuccess, data: $data)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PlanCreationResponseModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PlanCreationResponseModelImplCopyWith<_$PlanCreationResponseModelImpl>
      get copyWith => __$$PlanCreationResponseModelImplCopyWithImpl<
          _$PlanCreationResponseModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PlanCreationResponseModelImplToJson(
      this,
    );
  }
}

abstract class _PlanCreationResponseModel implements PlanCreationResponseModel {
  const factory _PlanCreationResponseModel(
  ...
  factory _PlanCreationResponseModel.fromJson(Map<String, dynamic> json) =
      _$PlanCreationResponseModelImpl.fromJson;
