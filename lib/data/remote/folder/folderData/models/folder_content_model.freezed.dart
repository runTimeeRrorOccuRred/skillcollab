...
FolderContentResponseModel _$FolderContentResponseModelFromJson(
    Map<String, dynamic> json) {
  return _FolderContentResponseModel.fromJson(json);
}

/// @nodoc
mixin _$FolderContentResponseModel {
  @JsonKey(name: "code")
  ...
  @JsonKey(ignore: true)
  $FolderContentResponseModelCopyWith<FolderContentResponseModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FolderContentResponseModelCopyWith<$Res> {
  factory $FolderContentResponseModelCopyWith(FolderContentResponseModel value,
          $Res Function(FolderContentResponseModel) then) =
      _$FolderContentResponseModelCopyWithImpl<$Res,
          FolderContentResponseModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$FolderContentResponseModelCopyWithImpl<$Res,
        $Val extends FolderContentResponseModel>
    implements $FolderContentResponseModelCopyWith<$Res> {
  _$FolderContentResponseModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$FolderContentResponseModelImplCopyWith<$Res>
    implements $FolderContentResponseModelCopyWith<$Res> {
  factory _$$FolderContentResponseModelImplCopyWith(
          _$FolderContentResponseModelImpl value,
          $Res Function(_$FolderContentResponseModelImpl) then) =
      __$$FolderContentResponseModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "code") int? code,
...
/// @nodoc
class __$$FolderContentResponseModelImplCopyWithImpl<$Res>
    extends _$FolderContentResponseModelCopyWithImpl<$Res,
        _$FolderContentResponseModelImpl>
    implements _$$FolderContentResponseModelImplCopyWith<$Res> {
  __$$FolderContentResponseModelImplCopyWithImpl(
      _$FolderContentResponseModelImpl _value,
      $Res Function(_$FolderContentResponseModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$FolderContentResponseModelImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$FolderContentResponseModelImpl implements _FolderContentResponseModel {
  const _$FolderContentResponseModelImpl(
      {@JsonKey(name: "code") this.code,
      @JsonKey(name: "message") this.message,
      @JsonKey(name: "isSuccess") this.isSuccess,
      @JsonKey(name: "data") this.data});

  factory _$FolderContentResponseModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$FolderContentResponseModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'FolderContentResponseModel(code: $code, message: $message, isSuccess: $isSuccess, data: $data)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$FolderContentResponseModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$FolderContentResponseModelImplCopyWith<_$FolderContentResponseModelImpl>
      get copyWith => __$$FolderContentResponseModelImplCopyWithImpl<
          _$FolderContentResponseModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$FolderContentResponseModelImplToJson(
      this,
    );
  }
}

abstract class _FolderContentResponseModel
    implements FolderContentResponseModel {
  const factory _FolderContentResponseModel(
  ...
  factory _FolderContentResponseModel.fromJson(Map<String, dynamic> json) =
      _$FolderContentResponseModelImpl.fromJson;
...
abstract class _FolderGroup implements FolderGroup {
  const factory _FolderGroup(
      {@JsonKey(name: "_id") final String? id,
      @JsonKey(name: "groupId") final GroupId? groupId}) = _$FolderGroupImpl;
